...
checkvalide &= verifiltre( /^(?:(?:\+33\s?|0)[1-9](?:[\s.-]?\d{2}){4})$/,document.getElementById("Tel"),"numéros de téléphone invalide")}
...
if(checkvalide){
    form.submit();//si checkvalide est vraie alors envoie le formulaire
}
})
})
